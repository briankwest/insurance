...
@swaig.endpoint("Verify insurance status",
    insurance_provider=SWAIGArgument("string", "Insurance provider name"),
    member_id=SWAIGArgument("string", "Member ID number"),
    date_of_birth=SWAIGArgument("string", "Date of birth (YYYY-MM-DD)"))
...
@swaig.endpoint("Schedule therapy session",
    member_id=SWAIGArgument("string", "Member ID number"),
    preferred_date=SWAIGArgument("string", "Preferred date (YYYY-MM-DD)"),
    preferred_time=SWAIGArgument("string", "Preferred time (HH:MM)"),
    therapist_id=SWAIGArgument("string", "Therapist ID"))
